...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*.so,vendor/lineage/prebuilt/suda/lib/$(SUDA_CPU_ABI),system/lib64) \
    $(call find-copy-subdir-files,*.so,vendor/lineage/prebuilt/suda/lib/armeabi-v7a/,system/lib)
else
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*.so,vendor/lineage/prebuilt/suda/lib/$(SUDA_CPU_ABI),system/lib)
endif
